...
# VSSM parameters
_C.MODEL.VSSM = CN()
_C.MODEL.VSSM.PATCH_SIZE = 4 #输入图像被切分成大小为 4x4 的小块
_C.MODEL.VSSM.IN_CHANS = 3 #输入图像的通道数，默认为 3
_C.MODEL.VSSM.EMBED_DIM = 96 #嵌入的维度大小
_C.MODEL.VSSM.DEPTHS = [2, 2, 9, 2] #模型的分层深度设计
_C.MODEL.VSSM.MLP_RATIO = 4. #多层感知机的扩展因子
_C.MODEL.VSSM.PATCH_NORM = True #是否对 patch 进行归一化
