...
slice_num = 0
mask_path = sorted(glob.glob("/home/colin/文档/Resources/database_nifti/patient0001/*.nii.gz"))
for case in mask_path:
    ...
    if os.path.exists(msk_path):
        ...
        for slice_ind in range(image.shape[0]):
            f = h5py.File(
                '/home/colin/Mamba-UNet-main/data/Colin2/{}_slice_{}.h5'.format(item, slice_ind), 'w')
            f.create_dataset(
